  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold mb-2">Internship/Job Applications</h1>
          <div className="flex items-center gap-2 text-sm text-gray-600">
            <span>Dashboard</span>
            <span>›</span>
            <span className="text-gray-900">Internship/Job Applications</span>
          </div>
        </div>
              ...
              <tbody>
                ...
                {filteredApplications.map(app => (
                  <tr key={app.id} className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900">{app.openings}</td>
